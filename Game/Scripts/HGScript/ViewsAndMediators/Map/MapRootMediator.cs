...
//            selectedNodeList.Clear();
            if (thisNode.idx != selectedRoleNode.idx)
            {
                List<MapNavNode> autoGeneratedPath = mapRootView.Path<MapNavNode>(selectedRoleNode, thisNode,mapRootView.NodeCostCallback);
...
//            Debug.Log(selectedRoleInfo.direction_param.Count);
